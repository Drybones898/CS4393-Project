...
public class InventorySingleton : MonoBehaviour
{
    ...
    {
        inventory.Add(new Item { itemName = "Milk", itemDesc = "Fresh milk", quantity = 10, rating = 4.5, price = 2.5, amtInCart = 0, category = "Drink" });
        inventory.Add(new Item { itemName = "Eggs", itemDesc = "Dozen eggs", quantity = 20, rating = 4.8, price = 3.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Bread", itemDesc = "Whole wheat bread", quantity = 15, rating = 5, price = 2.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Apples", itemDesc = "Red apples", quantity = 30, rating = 4.3, price = 1.0, amtInCart = 0, category = "Produce" });
        inventory.Add(new Item { itemName = "Bananas", itemDesc = "Ripe bananas", quantity = 25, rating = 4.4, price = 1.5, amtInCart = 0, category = "Produce" });
        inventory.Add(new Item { itemName = "Potatoes", itemDesc = "Fresh potatoes", quantity = 20, rating = 4.1, price = 1.0, amtInCart = 0, category = "Produce" });
        ...
        inventory.Add(new Item { itemName = "Tomatoes", itemDesc = "Juicy tomatoes", quantity = 30, rating = 4.4, price = 1.2, amtInCart = 0, category = "Produce" });
        ...
        inventory.Add(new Item { itemName = "Beef", itemDesc = "Lean beef steak", quantity = 8, rating = 4.6, price = 9.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Pasta", itemDesc = "Whole grain pasta", quantity = 15, rating = 5, price = 2.5, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Rice", itemDesc = "Brown rice", quantity = 20, rating = 4, price = 1.5, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Cereal", itemDesc = "Multigrain cereal", quantity = 10, rating = 4.4, price = 3.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Yogurt", itemDesc = "Low-fat yogurt", quantity = 15, rating = 4.2, price = 2.0, amtInCart = 0, category = "Groceries" });
        ...
        inventory.Add(new Item { itemName = "Butter", itemDesc = "Salted butter", quantity = 8, rating = 4.6, price = 2.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Oil", itemDesc = "Olive oil", quantity = 10, rating = 4, price = 5.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Sugar", itemDesc = "White sugar", quantity = 20, rating = 5, price = 1.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Flour", itemDesc = "All-purpose flour", quantity = 15, rating = 4.4, price = 2.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Salt", itemDesc = "Sea salt", quantity = 10, rating = 4.6, price = 1.0, amtInCart = 0, category = "Groceries" });
        ...
        inventory.Add(new Item { itemName = "Water", itemDesc = "Bottled water", quantity = 30, rating = 5, price = 1.0, amtInCart = 0, category = "Drink" });
        inventory.Add(new Item { itemName = "Cookies", itemDesc = "Chocolate chip cookies", quantity = 15, rating = 4.4, price = 3.0, amtInCart = 0, category = "Snack" });
        inventory.Add(new Item { itemName = "Chips", itemDesc = "Potato chips", quantity = 20, rating = 4.6, price = 2.0, amtInCart = 0, category = "Snack" });
        inventory.Add(new Item { itemName = "Crackers", itemDesc = "Saltine crackers", quantity = 10, rating = 4.2, price = 1.5, amtInCart = 0, category = "Snack" });
        inventory.Add(new Item { itemName = "Nuts", itemDesc = "Mixed nuts", quantity = 12, rating = 4, price = 4.0, amtInCart = 0, category = "Snack" });
        inventory.Add(new Item { itemName = "Popcorn", itemDesc = "Microwave popcorn", quantity = 15, rating = 4.2, price = 2.5, amtInCart = 0, category = "Snack" });
        ...
        inventory.Add(new Item { itemName = "Candy", itemDesc = "Assorted candy", quantity = 20, rating = 4.6, price = 1.0, amtInCart = 0, category = "Snack" });
        ...
        inventory.Add(new Item { itemName = "Frozen Waffles", itemDesc = "Buttermilk waffles", quantity = 12, rating = 5, price = 2.0, amtInCart = 0, category = "Frozen" });
        ...
        inventory.Add(new Item { itemName = "Canned Tuna", itemDesc = "Chunk light tuna", quantity = 8, rating = 4.2, price = 2.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Granola Bars", itemDesc = "Oat and honey bars", quantity = 12, rating = 4.6, price = 3.0, amtInCart = 0, category = "Snack" });
        ...
        inventory.Add(new Item { itemName = "Dried Beans", itemDesc = "Black beans", quantity = 10, rating = 5, price = 1.0, amtInCart = 0, category = "Groceries" });
        inventory.Add(new Item { itemName = "Dried Fruits", itemDesc = "Mixed dried fruits", quantity = 10, rating = 4.4, price = 2.0, amtInCart = 0, category = "Groceries" });
